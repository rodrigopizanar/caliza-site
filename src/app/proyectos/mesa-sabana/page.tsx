      ...
      <main>
        ...
        <section className="px-8 md:px-16 pt-16 pb-12">
          ...
          >
            ...
            >
              Un objeto de diseño fabricado con intención y rigor material. Cada decisión responde a la forma, la proporción y la permanencia del trabajo.
            </p>
          </div>
        </section>
        ...
        <section className="px-8 md:px-16 pb-16" aria-label="Galería del proyecto">
          <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem", maxWidth: "900px" }}>
            <div style={{ width: "100%", aspectRatio: "16/9", overflow: "hidden" }}>
              <img
                src="/images/zaguan-1105-01.jpg"
                alt="Mesa Sabana — detalle de fabricación"
                style={{ width: "100%", height: "100%", objectFit: "cover", display: "block" }}
              />
            </div>
